...
public class FindPositionsGroupPascalHearts{
	...
	//实现 罗瑶光 
	public static Map<Double, Position2D> getPosition2DsGroupPascalHearts(List<Position2D> groups, double scale) {
		Map<Double, List<Position2D>> pascalGroups= FissileWithMatch.fissilePosition2DWithMatch(groups, scale);
	...
	public static Map<Double, Position2D> getPosition2DsGroupPascalMids(List<Position2D> groups, double scale) {
		Map<Double, List<Position2D>> pascalGroups= FissileWithMatch.fissilePosition2DWithMatch(groups, scale);
	...
	public static Map<Double, Line2D> getPosition2DsGroupPascalDirection(List<Position2D> groups, double scale){
